...
<html>
  <head>  
    ...
    <meta name="csrf-token" content="SbuSAa3KP1mkcccTKO9tSxO9IercwkIoBmxNS9lWqDWYExq1U8AUrrMdznsCT5PkRC95WQzJjqP/3JDJuiJomA==" />
  ...
  <body> <!-- https://podio.com/webforms/19143195/1288689 -->
    <div class="container">
        <form class="webforms" id="webform" data-locale="es_ES" enctype="multipart/form-data" action="https://podio.com/webforms/12984991/885253" accept-charset="UTF-8" method="post">
          <input name="utf8" type="hidden" value="&#x2713;" />
          <input type="hidden" name="authenticity_token" value="Aplf7rO1+oMxIsRmpc4WL2YxOYBmfMNQTcHNGHF50+rTMddaTb/RdCZOzQ6PbuiAMaNhM7Z3D9u0cRCaEg0TRw==" />
          <h1 class="webforms__heading">
            Emprendedor Global
          </h1>
          <div class="webforms__description"> <!-- Descripcion del form -->
            <p>Viaja y viví una experiencia profesional con AIESEC. Completá tus datos debajo para generar un perfil gratuito en nuestra plataforma global y aplicar a nuestras pasantías globales.</p>
          </div>
            ...
            <div class="form-group"><!--Universidades-->
                ...
                <div class="webforms__field app-field">
                    <select name="fields[universidad]" id="field_universidad" class="form-control" required="required">
                          ...
                          <option value="218566387">Liceo Municipal Antonio Fuentes de Arco</option>
                          ...
                          <option value="217439902">ORT</option>
                          ...
                          <option value="217439879">UNICEN</option>
                          ...
                          <option value="217439808">ENS en Lenguas Vivas &quot;Sofía E. B. de Spangenberg&quot;</option>
                          ...
                          <option value="217439704">Universidad Nacional de la Cuenca del Plata</option>
                          <option value="217439703">-OTRA-</option>
                          ...
                          <option value="217439680">Escuela de Fotografía Motivarte</option>
                          <option value="217439679">Colegio Universitario de Periodismo CUP | Sede Córdoba</option>
                          <option value="217439678">Instituto Superior Mariano Moreno</option>
                          ...
                          <option value="217439666">Universidad Nacional de Cuyo - Facultad de Ciencias Económicas</option>
                          <option value="217439665">Universidad Nacional de Cuyo - Facultad de Ciencias Médicas</option>
                          <option value="217439664">Universidad Nacional de Cuyo - Facultad de Ciencias Políticas y Sociales</option>
                          <option value="217439663">Universidad Nacional de Cuyo - Facultad de Arte y Diseño</option>
                          <option value="217439662">Universidad Nacional de Cuyo - Facultad de Derecho</option>
                          <option value="217439661">Universidad Nacional de Cuyo - Facultad de Filosofía y Letras</option>
                          <option value="217439660">Universidad Nacional de Cuyo - Facultad de Educación Elemental y Especial</option>
                          <option value="217439659">Universidad Nacional de Cuyo - Facultad de Ciencias Básicas y Tecnológicas</option>
                          <option value="217439658">Universidad Nacional de Cuyo - Facultad de Ingeniería</option>
                          <option value="217439657">Universidad Nacional de Cuyo - Arquitectura</option>
                          <option value="217439656">Universidad Tecnológica Nacional (UTN) - Santa Fe</option>
                          <option value="217439654">Universidad Nacional del Litoral (UNL)</option>
                          <option value="217439653">Universidad Católica Argentina (UCA) - Paraná</option>
      ...
      <div hidden class="bootstrap-data hidden-data" id="bootstrap-data-PodioConfig">{&quot;webformIdentifier&quot;:1288689,&quot;webformTheme&quot;:&quot;flatly&quot;,&quot;base_domain&quot;:&quot;podio.com&quot;,&quot;recaptcha_enabled&quot;:false,&quot;recaptcha_public_key&quot;:null,&quot;locale&quot;:&quot;es_ES&quot;,&quot;csrfToken&quot;:&quot;8YdIvraroR/zp6S4hUTGtHezk34GYiz2mv7+uHycaCpOWtoR0/kA4YvQqUxSmH66SxxCe7ZNizwY9DMHBgvACg==&quot;,&quot;asset_host&quot;:&quot;https://d2cmuesa4snpwn.cloudfront.net/webforms&quot;}</div>
    </div>
